#!/usr/bin/env python
"""Dedup People — one-shot data-quality pass.

Runs crm_dedup.py --people (prints suspected duplicates for review).
Enrichment is now handled by prosper's MCP `enrich_people` tool, not a
